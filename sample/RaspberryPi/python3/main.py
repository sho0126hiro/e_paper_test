...
try:
    ...
    font24 = ImageFont.truetype('/opt/vc/src/hello_pi/hello_font/Vera.ttf', 24)
    ...
    font18 = ImageFont.truetype('/opt/vc/src/hello_pi/hello_font/Vera.ttf', 18)
    ...
    redimage1 = Image.new('1', (epd2in9b.EPD_HEIGHT, epd2in9b.EPD_WIDTH), 255)  # 298*126    
